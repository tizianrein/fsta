...
const BRAIN_PROMPTS = {
    ...
    "readymade-brain": "REPAIR PHILOSOPHY: This philosophy treats repair as an act of radical re-appropriation, sourcing its materials from the mundane, the discarded, and the mass-produced. The process itself is often a chaotic bricolage, where commonplace items are forcefully transformed through inventive, ad-hoc techniques to serve an entirely new function. Success is measured not by seamless integration but by the wit and audacity of the solution. A piece of packaging, a hardware store staple, or household trash becomes the repair, redefining authenticity not in the original fabric but in the clever, resourceful leap that gives a found object a new and unexpected purpose.",
